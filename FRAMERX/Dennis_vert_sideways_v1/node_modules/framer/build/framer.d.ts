 ...
 * and afterwards animated with {@link animate}.
 * @remarks
 * ```jsx
...
/**
 * Animate an {@link Animatable} value to a new value.
 * @remarks
 ...
 * @public
 * @deprecated Use {@link AnimationProps.animate} on {@link Frame} instead.
 */
...
export declare namespace animate {
     ...
     * @param options.duration - Duration of the animation
     * @param options.curve - One of the {@link Bezier} enum values or an array with 4 control points
     * @returns Instance of {@link FramerAnimation} that can be used to control the animation
     * @deprecated Use {@link AnimationProps.animate} on {@link Frame} instead.
     */
...
/**
 * @remark do no use separately from FrameProps
 * @public
 * */
...
declare interface ComponentLoader {
    ...
    /* Excluded from this release type: tokensForPackage */
}
...
/**
 * @internalremark do no use separately from FrameProps
 * @public
 * */
...
/**
 * @public
 * @internalRemark The release tag on this should be internal, but API extractor does not support that yet: https://github.com/Microsoft/web-build-tools/issues/972
 */
...
/**
 * The animation object returned by the {@link animate} functions
 * @remarks
...
/**
 * All properties that can be used with the {@link Page} component it also extends all {@link DeprecatedScrollProperties} properties.
 * ```jsx
 * <Page
